document.addEventListener('DOMContentLoaded', () => {
  ...
  // Retrieve cumulative_biases from chrome storage
  chrome.storage.local.get('cumulative_biases', (result) => {
    let cumulative_biases = result.cumulative_biases || {};

    // Initialize the biases arrays if they don't exist
    cumulative_biases = {
      racial_bias: cumulative_biases.racial_bias || [],
      gender_bias: cumulative_biases.gender_bias || [], 
      age_bias: cumulative_biases.age_bias || [],
      religious_bias: cumulative_biases.religious_bias || [],
      class_bias: cumulative_biases.class_bias || [],
      disability_bias: cumulative_biases.disability_bias || [],
      sexual_orientation_bias: cumulative_biases.sexual_orientation_bias || [],
      cultural_bias: cumulative_biases.cultural_bias || [],
      body_size_bias: cumulative_biases.body_size_bias || [],
      nationalism_ethnocentrism: cumulative_biases.nationalism_ethnocentrism || [],
      intersectional_bias: cumulative_biases.intersectional_bias || [],
      generalizations: cumulative_biases.generalizations || [],
      stereotypes: cumulative_biases.stereotypes || [],
      unfair_statements: cumulative_biases.unfair_statements || [],
    };

    // Extend biases with the response data
    ...
    // Save the updated cumulative_biases back to chrome storage
